...
# %% [cell 4]
get_ipython().run_cell_magic('sql', '', """SELECT * FROM sql_101_transactions LIMIT 5;""")
...
get_ipython().run_cell_magic('sql', '', """SELECT t.*,
       p.brand,
       p.product_name
...
get_ipython().run_cell_magic('sql', '', """SELECT * FROM sql_101_transactions;""")
...
get_ipython().run_cell_magic('sql', '', """DROP TABLE IF EXISTS sql_101_transactions_ext;
...
get_ipython().run_cell_magic('sql', '', """SELECT * FROM sql_101_transactions_ext LIMIT 10;""")
