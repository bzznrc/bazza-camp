...
get_ipython().run_cell_magic('sql', '', """SELECT SUM(tot_spent) AS total_revenue
...
get_ipython().run_cell_magic('sql', '', """SELECT SUM(amount) AS total_units_sold
FROM sql_101_transactions_ext
WHERE transaction_date > '2024-06-01';""")
...
# %% [cell 9]
# Finding the minimum and maximum total spent in transactions after June 1st

get_ipython().run_cell_magic('sql', '', """SELECT MIN(tot_spent) AS min_spent,
...
# %% [cell 11]
# Calculating the average total spent after June 1st

get_ipython().run_cell_magic('sql', '', """SELECT AVG(tot_spent) AS avg_spent
FROM sql_101_transactions_ext
WHERE transaction_date > '2024-06-01';""")
...
get_ipython().run_cell_magic('sql', '', """SELECT ROUND(AVG(tot_spent), 2) AS avg_spent
FROM sql_101_transactions_ext
WHERE transaction_date > '2024-06-01';""")
...
# %% [cell 15]
# Counting the number of transactions after June 1st

get_ipython().run_cell_magic('sql', '', """SELECT COUNT(*) AS count_transactions,
...
get_ipython().run_cell_magic('sql', '', """SELECT * FROM sql_101_transactions_ext WHERE product_name = 'Spaghetti N5' LIMIT 5;""")
...
get_ipython().run_cell_magic('sql', '', """SELECT brand, 
       category,
...
get_ipython().run_cell_magic('sql', '', """SELECT brand, category
FROM sql_101_transactions_ext
GROUP BY brand, category
ORDER BY brand, category;""")
...
get_ipython().run_cell_magic('sql', '', """SELECT store_name,
       COUNT(*) AS nr_transactions, 
       ROUND(AVG(price_per_unit), 2) AS avg_unit_price,
       ROUND(AVG(tot_spent), 2) AS avg_tot_spent,
       MAX(transaction_date) AS last_transaction
...
# %% [cell 32]
get_ipython().run_cell_magic('sql', '', """SELECT brand, product_name,
